...
import model.ObserverEmbalador;
import model.ObserverEntregador;
import model.Pedido;
            ...
            if(cliente.getID() == Integer.parseInt(idclien)){
                try {
                    ...
                    try {
                        ...
                        ObserverEntregador observerEn = new ObserverEntregador();
                        observerEn.update(2);
                        
                        
                        ObserverEmbalador observerE = new ObserverEmbalador();
                        observerE.update(2);
